...
export const STATS = {
  ...
  tower:{name:'哨塔',hp:450,armor:5,vision:10*1.3,range:7+1,damage:15,cooldown:1.2,food:100,ore:150,buildTime:45,maxBuilders:2,halfSize:1,antiAir:true,antiAirRange:2+4},
