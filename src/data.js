...
export const TECHNOLOGIES = {
  ...
  steamCore:{name:'蒸汽核心',section:'机械',food:700,ore:700,researchTime:120},
...
export const STATS = {
  shield:{name:'盾兵',hp:60,armor:7,damage:14,cooldown:1,range:1.5,speed:1.75,vision:9,food:50,ore:10,trainTime:5,movable:true,air:false},
  ironShield:{name:'铁甲兵',hp:60,armor:10,damage:16,cooldown:1,range:1.5,speed:1.75,vision:9,food:50,ore:15,trainTime:5,movable:true,air:false},
  archer:{name:'弓箭兵',hp:40,armor:1,damage:15,cooldown:1.2,range:6,speed:1.6,vision:9,food:60,ore:10,trainTime:5,movable:true,air:false,antiAir:true,ranged:true},
  crossbow:{name:'强弩兵',hp:40,armor:3,damage:22,cooldown:1.2,range:6,speed:1.6,vision:9,food:60,ore:15,trainTime:5,movable:true,air:false,antiAir:true,ranged:true},
  ...
  base:{name:'前线基地',hp:2000,armor:5,vision:10,food:300,ore:400,buildTime:240,maxBuilders:6,healRange:6,healRate:2,healTargets:5,pop:50},
  mine:{name:'采矿场',hp:1000,armor:5,vision:10,food:200,ore:200,buildTime:180,halfSize:1.5,oreRate:4},
  tower:{name:'哨塔',hp:600,armor:5,vision:10*1.3,range:8,damage:15,cooldown:1.2,food:150,ore:150,buildTime:45,maxBuilders:2,halfSize:1,antiAir:true,antiAirRange:6},
  factory:{name:'食物厂',hp:1000,armor:5,vision:10,food:200,ore:200,buildTime:180,halfSize:1.5,foodRate:5,foodRateOff:2},
