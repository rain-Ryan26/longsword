...
export const STATS = {
  ...
  armoredCar:{name:'铁甲车',hp:200,armor:10,damage:22,cooldown:.6,range:7,speed:2.45,vision:10,food:150,ore:150,trainTime:4,movable:true,air:false,ranged:true,machine:true,visualSize:1.2,collisionRadius:.55},
  steamWalker:{name:'蒸汽步行机',hp:300,armor:20,damage:70,cooldown:1,range:10,speed:1.4,vision:13,food:300,ore:500,trainTime:4,movable:true,air:false,ranged:true,machine:true,visualSize:1.35,collisionRadius:.65,projectileKind:'cannonball',splashDamage:20,splashRadius:2,audioEvent:'cannonFire'},
